...
let miCadena = "Agua panela con limon"
console.log(miCadena.length)

// Ejercicio 8: Crea una variable llamada miArray y asígnale un array con 3 elementos de tu elección, estos elementos deben ser string, number y array. Imprime el array en la consola.
let miArray = ["agua", 10, [NaN]]
console.log(miArray)
...
alert(`Hola ${nombreUsuario} un placer verte`)
...
let miConfirmacion = confirm("Te gusta programar")
console.log(`Es ${miConfirmacion} que te gusta programar`)
...
console.warn("Esto es una practica")
